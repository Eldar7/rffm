#!/usr/bin/env python3
"""
v2 PROOF-OF-CONCEPT: identical to season_comparison.py except load_all_data()
sources matches/teams/competitions from output/processed/rffm_parquet/ via
rffm_data.read_table() instead of pd.read_csv(). SEASONS is unchanged - it
scans output/processed/rffm/ directory names, not file contents.
