...
raw = json.load(open('notebooks/atletico_metro/metro_raw_v3.json', encoding='utf-8'))
links_raw = json.load(open('notebooks/atletico_metro/metro_links_v3.json', encoding='utf-8'))
intra = json.load(open('notebooks/atletico_metro/intra_transfers_v3.json', encoding='utf-8'))
team_slug_map = json.load(open('notebooks/atletico_metro/team_slug_map_v3.json', encoding='utf-8'))
...
with open('notebooks/atletico_metro/metro_final_v3.json', 'w', encoding='utf-8') as f:
